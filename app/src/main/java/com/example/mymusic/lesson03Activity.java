...
public class lesson03Activity extends AppCompatActivity implements View.OnClickListener {
    private CardView grammer3CardView,kanji3CardView,vocabulary3CardView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vocabulary3CardView = findViewById(R.id.vocabulary03CardViewId);
        vocabulary3CardView.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        }else if (v.getId() == R.id.vocabulary03CardViewId){
            Intent vocabulary03 = new Intent(lesson03Activity.this,vocabulary_03Activity.class);
            startActivity(vocabulary03);
        }
    }
}
