...
public class vocabulary_02Activity extends AppCompatActivity {
    ...
    {
        String[] headerString = getResources().getStringArray(R.array.vocabulary02_title);
        String[] childString = getResources().getStringArray(R.array.vocabulary02_description);
